...
- **Employee generalization** — `Cashier`, `StoreManager`, `SystemAdministrator` share identity/role attributes but have different permissions, motivating a role hierarchy rather than a single flat `User` class.
